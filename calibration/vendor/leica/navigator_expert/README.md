...
- `current/calibration.json` stores promoted optical calibration.
- `current/stage.json` stores measured stage limits and backlash.
...
Runtime code reads only the promoted files under `calibration/vendor/leica/navigator_expert/current/`.
