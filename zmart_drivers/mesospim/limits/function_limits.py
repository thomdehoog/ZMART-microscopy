...
This module was the repo-level ``shared/limits`` package until shared/ was
dissolved into the drivers; the mesoSPIM driver is its home now. The Leica
driver carries its own equivalent inside ``navigator_expert``.
"""
