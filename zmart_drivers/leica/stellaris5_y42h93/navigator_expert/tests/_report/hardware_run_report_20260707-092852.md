...
- **Date**: 2026-07-07
- **Started / finished**: 09:28:52 / 09:28:53 (1.4s)
...
- **Driver log**: `\\zmbstaff.core.uzh.ch\zmbstaff\10374\Protocols_Notes\thom\notes\repositories\smart-microscopy\zmart_drivers\leica\stellaris5_y42h93\navigator_expert\tests\_report\driver_log_20260707-092852.log` (full log-line capture)
...
|---|---:|---:|---:|---:|
| read-only | 6 | 0.016s | 0.156s | 0.171s |

### Slowest actions

| Duration | Phase | Action | Status |
|---:|---|---|---|
| 0.171s | read-only | get_scan_status | PASS |
| 0.156s | read-only | get_xy | PASS |
| 0.156s | read-only | get_hardware_info | PASS |
| 0.156s | read-only | settings: read | PASS |
...
|---:|---|---|---|---|---|---|---|---|---|---:|
| 1 | 09:28:52.996 | setup | PASS |  |  | limits: connect handshake | limits_path='<machine-local snapshot>' |  |  | 0.000s |
| 2 | 09:28:53.001 | read-only | PASS |  |  | ping |  |  |  | 0.016s |
| 3 | 09:28:53.177 | read-only | PASS |  |  | get_scan_status |  |  |  | 0.171s |
| 4 | 09:28:53.200 | read-only | PASS |  |  | get_jobs |  |  |  | 0.016s |
| 5 | 09:28:53.366 | read-only | PASS |  |  | get_hardware_info |  |  |  | 0.156s |
| 6 | 09:28:53.522 | read-only | PASS |  |  | get_xy |  |  |  | 0.156s |
| 7 | 09:28:53.524 | read-only | PASS |  |  | job: resolved | job='HiRes' |  |  | 0.000s |
| 8 | 09:28:53.681 | read-only | PASS |  |  | settings: read | job='HiRes' |  |  | 0.156s |
