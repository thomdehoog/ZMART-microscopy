...
```
zmart_drivers/leica/stellaris5_y42h93/navigator_expert/   <-- THIS package (Leica/LAS X vendor driver)
...
# Put zmart_drivers/leica/stellaris5_y42h93 on sys.path so `navigator_expert`
