...
def lrp_verify_line_average(lrp_path, value, job_name):
    ...
    return _verify_job_attr(lrp_path, "LineAverage", str(int(value)), job_name)
...
def lrp_verify_line_accumulation(lrp_path, value, job_name):
    ...
    return _verify_job_attr(lrp_path, "Line_Accumulation", str(int(value)), job_name)
...
def lrp_verify_frame_average(lrp_path, value, job_name):
    ...
    return _verify_job_attr(lrp_path, "FrameAverage", str(int(value)), job_name)
...
def lrp_verify_frame_accumulation(lrp_path, value, job_name):
    ...
    return _verify_job_attr(lrp_path, "FrameAccumulation", str(int(value)), job_name)
