"""Create the conda environment for the population workflow.

One environment, ``ZMART--population--main``. Plotting a population needs a
table reader, principal components and UMAP -- pandas, scikit-learn and
umap-learn -- and no image readers, no torch, no GPU.
"""
