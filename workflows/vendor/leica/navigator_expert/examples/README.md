...
- `calibration/vendor/leica/navigator_expert/current/calibration.json` exists.
- `limits/vendor/leica/navigator_expert/current.json` exists. Run the
  calibration notebooks first and reset/update the limits for the scope.
