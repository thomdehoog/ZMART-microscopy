...
import numpy as np
import pytest
from workflow.retired.output_layout import Naming, build_position_analysis_name
...
class TestStyleTokenCoverage:
    """Pin the design intent at pipeline/visualize.py line 62:
...
class TestPlotOverviewTiles:
    def test_renders_triptych_for_each_tile(self, tmp_path):
        ...
        analysis_dir = tmp_path / "analysis"
        n0 = Naming(
            acquisition_type="overview-scan", hash6="abc123", position_label="g00000-p00000"
        )
        n1 = Naming(
            acquisition_type="overview-scan", hash6="abc123", position_label="g00000-p00001"
        )
    ...
    def test_centre_panel_imshow_uses_nearest(self):
        ...
        try:
            ...
            assert ax.images[0].get_interpolation() == "nearest", (
                ...
                f"resolution. See pipeline/visualize.py."
            )
        finally:
            plt.close(fig)
...
class TestLoadTileNpzPosition:
    ...
    def test_returns_position_when_present(self, tmp_path):
        ...
        naming = Naming(
            acquisition_type="overview-scan", hash6="abc123", position_label="g00000-p00007"
        )
...
class TestPngNaming:
    ...
    def test_overview_tile_png_name_canonical(self):
        ...
        stem = _position_stem(
            Naming(acquisition_type="overview-scan", hash6="abc123", position_label="g00000-p00007")
        )
