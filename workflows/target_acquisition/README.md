...
- `_bootstrap.py` — adds `microscopes/driver/vendor/leica/`, `microscopes/`, and the repo root to `sys.path` so the notebook can import the driver, calibration, shared packages, and workflow code.
