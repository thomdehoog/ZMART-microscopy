...
| Viewer full `tests/`, page built, real Chromium, `ZMART_REQUIRE_BROWSER=1` | `02cf88d` | still running when this review was written; the run at the 100% checkpoint is reported in `docs/design/viewer-delivery-implementation-plan-100-percent.md` |
